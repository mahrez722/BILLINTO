<?php
if(isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['user_phone number']) && isset($_POST['user_password'])){
...
// INSERT USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, user_phonenumber, user_password) VALUES ('$username', '$user_email', '$user_phonenumber','$user_hash_password')");
